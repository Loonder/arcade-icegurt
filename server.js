...
const http = require('http'); // Corrigido erro de digitação
...
const crypto = require('crypto'); // Módulo nativo para gerar IDs
...
const PONTOS_POR_GELADINHO = 5000; // Deve ser o mesmo valor do frontend
...
// Criar tabelas (AGORA COM INVENTÁRIO)
db.serialize(() => {
    db.run(`
    ...
    db.all(
        ...
        (err, rows) => {
            if (err) {
                ...
                // Retorna um array vazio em caso de erro para não quebrar o cliente
