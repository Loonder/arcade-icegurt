...
socket.on('compra-status', (dados) => {
    if (dados.sucesso) {
        ...
        // Não é necessário chamar atualizarInfoUsuario() aqui
        // pois o evento 'atualizar-inventario' já faz isso.
    } else {
...
function iniciarCS16() {
    ...
    // Aponta para um serviço externo que roda o CS 1.6 no navegador
    iframe.src = 'https://play-cs.com/pt/servers'; 
